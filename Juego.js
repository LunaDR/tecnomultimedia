class Juego {
  ...
  colision() {
    ...
    if (distancia < this.personaje.tam/2 + this.enemigo.tam/2) {
      print("we did it"); //para verificar que funciona
      this.estado = 2;
    }
  }
  ...
  inicio() {
    ...
    push();
    textSize(36);
    text("Escapa de la bruja en menos de 25 segundos!", this.x, this.y-50);
    text("Hansel y Gretel se mueven con las teclas A, S, W, D", this.x, this.y);
    text("Presiona ENTER para comenzar", this.x, this.y+140);
    pop();
  }
